...
const NavBar = () => {
  ...
  return (
    <div className='h-[80px] text-gray-300 fixed top-0 w-full overflow-hidden  flex justify-between items-center px-4  bg-[#0a193f] flex-col z-10'>
        <div className='flex justify-between items-center w-full h-[80px] '>
            <img src={Logo} alt='Logo Image' style={{width:'80px'}} />
        
            <ul className='hidden md:flex'>
                <li className='font-nav-bar px-[1rem] cursor-pointer' id='home'>
                    <Link to='home-page' smooth={true} duration={500}>Home</Link>

                </li>
                <li className='font-nav-bar px-[1rem] z-10 cursor-pointer' id='about'> <Link to='about-page' offset={-100} smooth={true} duration={500} >About</Link></li>
                <li className='font-nav-bar px-[1rem] z-10 cursor-pointer' id='skills'> <Link to='skills-page' offset={-100} smooth={true} duration={500}>Skills</Link></li>
                <li className='font-nav-bar px-[1rem] z-10 cursor-pointer' id='work'> <Link to='projects' offset={-100} smooth={true} duration={500}>Work</Link></li>
                <li className='font-nav-bar px-[1rem] z-10 cursor-pointer' id='contact'> <Link to='contact-page' offset={-100} smooth={true} duration={500}>Contact</Link></li>
            </ul>
            ...
            <div className='fixed w-[40px] bottom-0 left-[40px] z-[10]' id='social-media'>
                <ul className='md:flex flex-col items-center m-0 p-0 list-none hidden'>
                    <li className='hover:translate-y-[-3px] duration-[350ms] z-10 px-10  '>
                         <a href='/' style={{padding:0}} className='icon' >
                    ...
                    <li className='hover:translate-y-[-3px] duration-[350ms]'>
                         <a href='/'  style={{padding:10}}  className='icon'>
                         <svg style={{width:20,height:20}} xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram"><title>Instagram</title><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                    </a> 
                    </li>
                    <li className='hover:translate-y-[-3px] duration-[350ms]'>
